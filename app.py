...
def create_app(test_config=None):
    ...
    CLIENT_ID = '&client_id=3OQZn3BHPqNNoHSFMszQS1W7xwO5RYdd'
    REDIRECT_URI = '&redirect_uri=http://localhost:5000/'
    LOGIN = f"{AUTH0_DOMAIN}{AUDIENCE}{RESPONSE_TYPE}{CLIENT_ID}{REDIRECT_URI}"
...
if __name__ == '__main__':
    APP.run(host='https://capproject.herokuapp.com/', port='8080')
